...
The default constructor consists of an empty body, meaning it does not contain any explicit code. The compiler 
The defaulted destructed is a special type of destructor that is implicitly generated by the compiler when the user does not provide a custom destructor for a class. The defaulted destructor consists of an empty body, meaning it does not contain any explicit code.
